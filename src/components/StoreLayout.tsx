  ...
  return (
    <StoreConfigContext.Provider value={storeConfig}>
      <div className="min-h-screen" style={{ backgroundColor: storeConfig?.background_color, color: storeConfig?.text_color }}>
        ...
        <footer className=" text-white py-16 border-t" style={{ borderColor: storeConfig?.border_color || '#2A2A2A' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8">
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" onClick={(e) => { e.preventDefault(); setIsAboutModalOpen(true) }} className="text-gray-400 hover:text-white transition-colors">About Us</a></li>
