...
export default function AboutModal({ isOpen, onClose, store }: AboutModalProps) {
          ...
          <div className="space-y-4">
            {store?.email && (
              <div className="flex items-center gap-3">
                ...
                <a href={`mailto:${store.email}`} className="text-gray-700 hover:text-primary-color">
                  {store.email}
                </a>
              </div>
            )}
            ...
            {store?.phone && (
              <div className="flex items-center gap-3">
                ...
                <a href={`tel:${store.phone}`} className="text-gray-700 hover:text-primary-color">
                  {store.phone}
                </a>
              </div>
            )}
          ...
          {!store?.email && !store?.phone && (
            <>
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:osemuix@gmail.com" className="text-gray-700 hover:text-primary-color">
                  osemuix@gmail.com
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+233530405191" className="text-gray-700 hover:text-primary-color">
                  +233530405191
                </a>
              </div>
            </>
